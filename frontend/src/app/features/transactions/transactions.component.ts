  ...
  template: `
    <div class="animate-fade-in">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
        ...
        <div *ngIf="totalElements > 0" class="text-xs text-muted">
      ...
      <div class="bg-card border border-card-border rounded-2xl p-3 sm:p-4 mb-4 sm:mb-6">
        <div class="flex flex-col sm:flex-row gap-3">
          ...
          <button (click)="toggleSortDirection()"
            ...
            <svg *ngIf="sortDir === 'asc'" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 4.5h14.25M3 9h9.75M3 13.5h5.25m5.25-.75L17.25 9m0 0L21 12.75M17.25 9v12" />
            </svg>
            <svg *ngIf="sortDir === 'desc'" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div *ngIf="loading" class="flex flex-col items-center justify-center py-20 gap-3">
        ...
        <span class="text-sm text-muted">Loading transactions...</span>
      </div>
      ...
      <!-- Empty state -->
      <div *ngIf="!loading && !error && transactions.length === 0" class="glass-card p-10 sm:p-16 text-center animate-slide-up">
      ...
      <!-- Mobile card view -->
      <div *ngIf="!loading && !error && transactions.length > 0" class="sm:hidden space-y-2 animate-slide-up">
        <div *ngFor="let tx of transactions" class="glass-card p-3.5">
      ...
      <!-- Desktop table view -->
      <div *ngIf="!loading && !error && transactions.length > 0" class="hidden sm:block glass-card overflow-hidden animate-slide-up">
        <div class="overflow-x-auto">
          <table class="min-w-full">
            ...
            <tbody class="divide-y divide-card-border">
              <tr *ngFor="let tx of transactions" class="hover:bg-card-hover transition-colors">
