...
export class TransactionsService extends BaseService {
     ...
     * @param transactionSign Filter transactions by amount sign
     * @param page 
     * @param size 
    ...
    public uploadCsv(file: Blob, mapping: string, xCsvCharset?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (mapping === null || mapping === undefined) {
            throw new Error('Required parameter mapping was null or undefined when calling uploadCsv.');
        }
        ...
        if (mapping !== undefined) {
            localVarFormParams = localVarFormParams.append('mapping', <any>mapping) as any || localVarFormParams;
        }
