...
import com.tracker.rules.api.RuleMapper;
...
public class AdditionalRuleGroupMapper {
    ...
    public AdditionalRuleGroupDto toDto(AdditionalRuleGroupService.GroupWithCount groupWithCount) {
        ...
        dto.setRules(ruleMapper.toDtoList(group.getRules().stream()
                .sorted(Comparator.comparing(com.tracker.rules.domain.Rule::getCreatedAt,
                        Comparator.nullsLast(Comparator.naturalOrder()))
                        .thenComparing(com.tracker.rules.domain.Rule::getId, Comparator.nullsLast(Comparator.naturalOrder())))
                .toList()));
