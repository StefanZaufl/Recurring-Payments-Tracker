package com.tracker.recurringpayments.api;

import com.tracker.additionalrules.api.AdditionalGroupTransactionMatchMapper;
import com.tracker.recurringpayments.application.RecurringPaymentRecalculationService;
import com.tracker.rules.api.RecurringPaymentRuleRequestMapper;
...
import com.tracker.recurringpayments.domain.PaymentPeriodHistory;
import com.tracker.recurringpayments.domain.PaymentType;
import com.tracker.recurringpayments.application.PaymentPeriodHistoryService;
import com.tracker.recurringpayments.application.RecurringPaymentSimulationService;
import com.tracker.recurringpayments.application.RecurringPaymentService;
import com.tracker.rules.application.RuleCreateParams;
...
public class RecurringPaymentController implements RecurringPaymentsApi {
    ...
    private final com.tracker.recurringpayments.application.RecurringPaymentRecalculationService recalculationService;
    ...
    public RecurringPaymentController(RecurringPaymentService recurringPaymentService,
                                      ...
                                      com.tracker.recurringpayments.application.RecurringPaymentRecalculationService recalculationService) {
