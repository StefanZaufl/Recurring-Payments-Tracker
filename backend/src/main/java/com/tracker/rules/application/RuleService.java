...
public class RuleService {
    ...
    public Rule createRuleWithoutRecalculation(UUID recurringPaymentId, RuleMutation mutation) {
    ...
    public record RuleMutation(RuleType ruleType, TargetField targetField, String text, Boolean strict,
