...
import com.tracker.additionalrules.persistence.AdditionalRuleGroupRepository;
import com.tracker.bankaccounts.persistence.BankAccountRepository;
import com.tracker.categories.persistence.CategoryRepository;
import com.tracker.recurringpayments.persistence.PaymentPeriodHistoryRepository;
...
import com.tracker.rules.persistence.RuleRepository;
...
class AccountControllerTest {
    ...
    @Autowired
    private TransactionRecurringLinkRepository transactionRecurringLinkRepository;
    ...
    @BeforeEach
    void setUp() {
        transactionRecurringLinkRepository.deleteAll();
        paymentPeriodHistoryRepository.deleteAll();
