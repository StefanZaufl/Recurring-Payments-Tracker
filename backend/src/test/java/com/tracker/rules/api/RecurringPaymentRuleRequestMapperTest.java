...
class RecurringPaymentRuleRequestMapperTest {
    ...
    void mapsTextRuleFieldsIdenticallyForCreateAndSimulation() {
        ...
        assertThat(createParams.ruleType()).isEqualTo(com.tracker.rules.domain.RuleType.REGEX);
        assertThat(createParams.targetField()).isEqualTo(com.tracker.rules.domain.TargetField.PARTNER_NAME);
        assertThat(createParams.text()).isEqualTo("netflix.*");
        assertThat(simulationRule.getRuleType()).isEqualTo(com.tracker.rules.domain.RuleType.REGEX);
        assertThat(simulationRule.getTargetField()).isEqualTo(com.tracker.rules.domain.TargetField.PARTNER_NAME);
