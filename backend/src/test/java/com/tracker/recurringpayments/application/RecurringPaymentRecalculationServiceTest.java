...
import com.tracker.additionalrules.application.AdditionalMatchingService;
...
class RecurringPaymentRecalculationServiceTest {
    ...
    void targetedRecalculationRemovesStaleLinksAndAddsNewMatches() {
        ...
        when(detectionService.detectFrequency(List.of(retained, newlyMatched))).thenReturn(com.tracker.recurringpayments.domain.Frequency.MONTHLY);
